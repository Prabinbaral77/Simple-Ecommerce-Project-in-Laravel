...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('message','Categories Added Successfully!');
    }
    ...
    {
        if($category->delete()){
            return back()->with('message','Record Trashed Successfully!');
        }else{
    ...
    public function recoverCat($id)
    {
        ...
        if($category->restore()){
            return back()->with('message','Record restored Successfully!');
        }else{
            return back()->with('message','Error Restoring Record!');
        }
    }
