...
<form  action="@if(isset($user)) {{route('admin.profile.update', $user->profile()->slug)}} @else {{route('admin.profile.store')}} @endif" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	<div class="row">
		@csrf
		@if(isset($user))
		@method('PUT')
